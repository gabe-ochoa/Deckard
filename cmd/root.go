...
var RootCmd = &cobra.Command{
	Use:   "deckard",
	Short: "pod (replicant) killing tool",
	Long: `A tool to restart (kill) pods of a Kubernetes Deployment or Daemonset
	with respect to the restart strategy of the resource. 
`,
